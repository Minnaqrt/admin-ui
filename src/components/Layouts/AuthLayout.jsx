...
const AuthLayout = (props) => {
  ...
  return (
    <div className={`flex justify-center min-h-screen items-center ${isDarkMode ? 'bg-dark' : 'bg-special-mainBg'}`}>
      ...
      <motion.div
        ...
        className="w-full max-w-sm bg-special-mainBg"
      >
        <Logo />
        ...
        <div className="text-center mt-4">
          <button
            ...
            className="py-2 px-4 rounded-md text-sm bg-primary text-white flex items-center justify-center mx-auto"
          >
